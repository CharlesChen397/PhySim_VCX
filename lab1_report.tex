...
\author{学号：\underline{\hspace{4cm}}\quad 姓名：\underline{\hspace{3cm}}}
\date{\today}
...
\vspace{1em}
\noindent\textit{打包提交前请执行 \texttt{xmake clean -a} 清理构建产物；将 \texttt{lab1\_log.txt}（由 \texttt{git log --stat > lab1\_log.txt} 生成）、源代码与本报告及视频一并打入 \texttt{lab1\_<学号>.zip}。}
