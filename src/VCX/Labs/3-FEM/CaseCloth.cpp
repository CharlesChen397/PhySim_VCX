...
namespace VCX::Labs::FEM {
    ...
    void CaseCloth::OnSetupPropsUI() {
        ...
        ImGui::Text("Z + Left Drag: pull selected vertex");
    ...
    void CaseCloth::OnProcessInput(ImVec2 const & pos) {
        ...
        bool const dragging = ImGui::IsItemHovered() && ImGui::IsKeyDown(ImGuiKey_Z) && ImGui::IsMouseDown(ImGuiMouseButton_Left) && (io.MouseDelta.x != 0.f || io.MouseDelta.y != 0.f);
        if (dragging) {
